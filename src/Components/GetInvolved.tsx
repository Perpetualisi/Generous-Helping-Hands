...
import { Mail, Heart, Users, Gift, Instagram, ChevronDown, ChevronUp } from "lucide-react";
...
const faqs = [
  {
    ...
    answer:
      "100% of public donations go directly toward our core programs: providing educational materials for girls, funding women-led micro-businesses, and community advocacy.",
  },
  {
    question: "Can I donate from outside the country?",
    answer:
      "Yes! We accept international transfers. Please contact our team via email to receive the appropriate international banking details (SWIFT/IBAN).",
  },
  {
    question: "Is there a minimum donation amount?",
    answer:
      "No contribution is too small. Every bit of support helps us provide essential resources to those who need them most.",
  },
];
...
const donationMethods = [
  {
    ...
    description:
      "Account details available upon request. Contact our team to receive secure payment instructions.",
    icon: Heart,
  },
  {
    title: "In-Kind Donations",
    description:
      "Donate goods or services—educational materials, clothing, or professional expertise—that support our operations.",
    icon: Gift,
  },
];

// ------------------ REUSABLE COMPONENTS ------------------
const SectionHeader: React.FC<{ title: string; subtitle?: string | React.ReactNode }> = ({
  title,
  subtitle,
}) => (
  ...
  return (
    <section className="relative bg-white dark:bg-gray-950 transition-colors duration-500 py-16 sm:py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-32 lg:space-y-48">
        ...
        <div
          id="volunteer"
          className="scroll-mt-32 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center"
        >
            ...
            <div className="grid grid-cols-1 gap-4">
              {contactMethods.map((method, i) => (
                ...
                >
                  ...
                  <div>
                    <p className="text-xs font-bold text-blue-400 dark:text-blue-500 uppercase tracking-tight">
                      {method.text}
                    </p>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              {donationMethods.map((method, i) => (
                <div
                  key={i}
                  className="p-5 rounded-2xl bg-white dark:bg-gray-900 border border-blue-50 dark:border-blue-900/30 shadow-sm flex gap-5 hover:border-blue-200 transition-colors"
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-blue-100/60 mt-1 leading-relaxed">
                      {method.description}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-500">
              Everything you need to know about our work and contributions.
            </p>
          </div>
