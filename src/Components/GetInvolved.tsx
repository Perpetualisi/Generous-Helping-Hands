      ...
      <div className="relative rounded-3xl overflow-hidden border border-gray-100 dark:border-gray-800 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.14)] dark:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)]">
        ...
        {status === "error" ? (
          ...
          <img
            ...
            className={`w-full aspect-square object-contain bg-white dark:bg-gray-900 transition-opacity duration-500 ${
...
const VolunteerSection: React.FC = () => (
  <div id="volunteer" className="py-20 md:py-32 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
    <motion.div
      variants={fadeLeft}
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      <div className="space-y-3 pt-2">
        {CONTACT_METHODS.map((m) => (
          ...
          >
            <div className={`w-11 h-11 rounded-xl ${m.iconBg} flex items-center justify-center text-white shadow-md group-hover:scale-105 transition-transform shrink-0`}>
              <m.icon size={18} aria-hidden="true" />
            </div>
            <div className="min-w-0">
              <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-0.5">{m.label}</p>
...
const DonationSection: React.FC = () => (
  <div id="donation" className="py-20 md:py-32 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center border-t border-gray-100 dark:border-gray-800">
    <motion.div
      variants={fadeLeft}
      initial="hidden"
      whileInView="visible"
      ...
      <div className="space-y-5 pt-2">
        {DONATION_METHODS.map((m) => (
          <div key={m.title} className="flex gap-4">
            ...
            <div>
              <h4 className="font-black text-sm text-gray-900 dark:text-white uppercase tracking-wide mb-0.5">{m.title}</h4>
